...
const EventContentRight = (props) => {
  ...
  let roundRegex = /^(Preliminary Round|Preliminary Round Results|Finals|Judgement Criteria|[rR]ound [1-9]|General Rules|Rules for duet|Rules for group)|Introduction|Model United Nations Explanation|COMMITTEES OVERVIEW|1. United Nations Human Rights Council|1.1. Samples-agenda :|2. All India Political Parties Meet - In Present Era|2.1. Samples-Agenda :|3. Bollywood Committee Summit|3.1. Samples-agenda :|4. International Press|4.1. Samples-agenda :|HIGHLIGHTS OF THE EVENT|Miscellaneous$/i;
