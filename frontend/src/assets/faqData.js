...
const faqData = {
  "Campus Related Queries": [
    ...
    {
      question: "Is Id proof necessary to be carried in the fest?",
      answer: "Yes, it is necessary for the attendees to carry their college ID cards(for participants)/Aadhar Cards for registration at the entry gate. Anyone without a valid ID card will not be allowed to attend the fest."
    },
    {
      question: "Will the basic facilities and amenities be provided to the attendees?",
  ...
  "General Queries": [
    ...
    },
    {
      ...
      answer: "There is no dress code for the fest. You can go all out and pull up your best look for this awesome event."
    },
    {
  ...
  "Competition Related Queries": [
    ...
    },
    {
      ...
      answer: "On-spot registration may or may not be allowed. Hence, we recommend participants register beforehand."
    },
    {
      question: "Do all members require separate registration for group events?",
  ...
  "Travel Related Queries": [
    ...
    {
      question: "Will the college provide transportation for fest attendees?",
      answer: "You can contact the festival organizers directly. They can provide you with information on transportation options and any related arrangements that may be in place for the event."
    },
    {
      question: "How to explore the campus and event venues?",
      answer: "Maps of various events and their venues will be placed throughout the campus to ease navigation for the attendees."
    },
    {
      question: "Are cars allowed inside?",
